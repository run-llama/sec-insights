...
Pydantic Schemas for the API
"""
from pydantic import BaseModel, Field, field_validator  # Updated validator import
from pydantic import ConfigDict  # For model_config
from enum import Enum
from typing import List, Optional, Dict, Union, Any
from uuid import UUID
from datetime import datetime
...
def build_uuid_validator(*field_names: str):
    return field_validator(*field_names, mode="before")(lambda x: str(x) if x else x)
